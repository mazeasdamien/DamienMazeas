    ...
    if (document.body.id === 'home-page') {
        ...
        function renderPortfolio(sortOrder) {
            const portfolioData = [
                ...
                {category: 'side-projects', date: '2023-04-1', displayDate: '2023', url: 'videos/vrteleoperation.mp4', icon: 'images/logos/play.webp', title: '▶️ VR Teleoperation of a UR16e Robot', subtitle: 'YouTube Demo'},
                { category: 'side-projects', date: '2022-10-01', displayDate: '2022', url: 'videos/roboguideunity.mp4', icon: 'images/logos/play.webp', title: '▶️ Linking FANUC Roboguide software with Unity 3D', subtitle: 'YouTube Demo' },
                { category: 'side-projects', date: '2022-09-01', displayDate: '2022', url: 'videos/fanucpickandplace.mp4', icon: 'images/logos/play.webp', title: '▶️ Pick and place programmed with a FANUC robot', subtitle: 'YouTube Demo' },
                { category: 'side-projects', date: '2022-08-01', displayDate: '2022', url: 'videos/turtlebot.mp4', icon: 'images/logos/play.webp', title: '▶️ Remote control of a TurtleBot2 with the HoloLens 2', subtitle: 'YouTube Demo' },
                { category: 'side-projects', date: '2021-07-01', displayDate: '2021', url: 'https://www.maintenanceandengineering.com/2021/06/16/emerging-technologies-to-support-asset-management/', icon: 'svg_article', title: 'Emerging tech to support asset management', subtitle: 'Technical Article' },
                { category: 'side-projects', date: '2018-06-01', displayDate: '2018', url: 'videos/moulding.mp4', icon: 'images/logos/play.webp', title: '▶️ Visualization of an injection moulding in VR', subtitle: 'YouTube Demo' },
                { category: 'side-projects', date: '2017-05-01', displayDate: '2017', url: 'videos/production-line.mp4', icon: 'images/logos/play.webp', title: '▶️ Training procedure for starting a production line in VR', subtitle: 'YouTube Demo' },
