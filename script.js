    ...
    if (document.body.id === 'home-page') {
        ...
        function renderPortfolio(sortOrder) {
            const portfolioData = [
                ...
                { category: 'side-projects', date: '2018-06-01', displayDate: '2018', url: 'videos/moulding.mp4', icon: 'images/social/Youtube_logo.png', title: 'Visualization of an injection moulding in VR', subtitle: 'YouTube Demo' },
                { category: 'side-projects', date: '2017-05-01', displayDate: '2017', url: 'videos/production-line.mp4', icon: 'images/social/Youtube_logo.png', title: 'Training procedure for starting a production line in VR', subtitle: 'YouTube Demo' },
